...
function mesh_to_nodes_3d(nodes::Dict{Int, Vector{Float64}}, volume_elements::Dict{Int, Vector{Int}})
    ...
    for (i, (element_id, node_ids)) in enumerate(volume_elements) 
        ...
        elseif n == 8
            v1 = telvol(nodes_coords[1], nodes_coords[2], nodes_coords[4], nodes_coords[5])
            v2 = telvol(nodes_coords[2], nodes_coords[3], nodes_coords[4], nodes_coords[7])
            v3 = telvol(nodes_coords[2], nodes_coords[5], nodes_coords[6], nodes_coords[7])
            v4 = telvol(nodes_coords[4], nodes_coords[5], nodes_coords[7], nodes_coords[8])
            v5 = telvol(nodes_coords[2], nodes_coords[4], nodes_coords[5], nodes_coords[7])
